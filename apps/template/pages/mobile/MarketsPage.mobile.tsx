...
import { Sparkline } from '../../components-refactored/Chart';
import { Icon } from '../../components-refactored/Icon';
import { MobileSegmentedControl, MobileActionSheet, PullToRefresh } from '../../components-refactored/mobile';
import { MobileHeader } from '../../components-refactored/Layout';
          ...
          filteredMarkets.map((market) => (
            ...
            >
              ...
              <div className={styles.priceCol}>
                ...
                <div
                  className={`${styles.changeBadge} ${(market.ticker?.priceChangePercent ?? 0) >= 0 ? styles.positive : styles.negative
                    }`}
                >
                  {market.ticker

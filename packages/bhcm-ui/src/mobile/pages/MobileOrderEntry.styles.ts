...
const SideBtn = styled.button<SideBtnProps>`
  flex: 1;
  padding: 0.5rem 1rem;
  border: none;
...
const TypeBtn = styled.button<TypeBtnProps>`
  flex: 1;
...
const AvailableHint = styled.span`
  font-size: 11px;
  color: var(--text-tertiary, #6E7681);
`;
 ...
 * ═══════════════════════════════════════════════════════════
 */
const QuickPriceRow = styled.div`
  display: flex;
  gap: 0.5rem;
  margin-top: 4px;
`;

const QuickPriceBtn = styled.button`
  flex: 1;
  padding: 4px;
  background: var(--bg-secondary, #161B22);
  border: 1px solid var(--border-subtle, #262C36);
...
const SliderStep = styled.div<SliderStepProps>`
  width: 6px;
  height: 6px;
  border-radius: 50%;
...
const PercentLabel = styled.span<PercentLabelProps>`
  font-size: 10px;
  color: var(--text-tertiary, #6E7681);
  font-weight: 500;
  width: 24px;

...
const AssetQuoteRow = styled.div`
  display: flex;
  align-items: baseline;
  gap: 4px;
`;

const AssetQuote = styled.span`
  font-size: 10px;
  color: var(--text-tertiary, #6E7681);
  font-weight: 500;
`;
...
const ChangeBadge = styled.div<ChangeBadgeProps>`
  min-width: 72px;
  height: 28px;
  display: flex;
  align-items: center;
...
const FavoritesSegment = styled.div<FavoritesSegmentProps>`

...
/* DepositDrawer - Slide-in panel for deposits */
...
export const AssetButton = styled.button<ActiveButtonProps>`
  flex: 1;
  padding: 0.75rem;
  font-size: 0.875rem;
  font-weight: 500;
...
export const SourceTypeButtons = styled.div`
  display: flex;
  gap: 0.5rem;
`;

export const SourceTypeButton = styled.button<ActiveButtonProps>`
  flex: 1;
  display: flex;
  align-items: center;
  justify-content: center;
...
export const NoSourcesHint = styled.div`
  padding: 0.75rem;
  font-size: 0.75rem;
  color: var(--text-tertiary, #6E7681);
  text-align: center;

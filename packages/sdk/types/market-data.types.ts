// CurrencyCode is defined in account.types.ts - do not re-export here to avoid conflicts
...
export interface Candle {
	...
	volume?: number;
	ts: number;
	/** Alias for ts - used by some services */
	timestamp?: number;
...
//   CollectorErrorType,
//   ICollector,
// } from '../../market-data/src/domains/collectors/collector.types.js';

// // Normalizer types
// export type {
//   EnrichedTick,
//   TickBatch,
// } from '../../market-data/src/domains/normalizer/normalizer.types.js';
...
//   PriceSnapshot,
//   CacheStats,
// } from '../../market-data/src/domains/cache/cache.types.js';

// // Historical types
// export type {
//   CandleQuery,
// } from '../../market-data/src/domains/historical/historical.types.js';
...
//   TickMessage,
//   SnapshotMessage,
// } from '../../market-data/src/domains/stream/stream.types.js';

// // Health types
// export type {
//   ServiceHealth,
//   Metrics,
// } from '../../market-data/src/domains/health/health.types.js';

// // Config types
// export type {
//   AssetKind,
//   SymbolDefinition,
// } from '../../market-data/src/config/symbols.js';
...
export interface WalletLedgerEntry {
  ...
  balanceAfter?: string;    // Post-operation balance snapshot (optional)
  referenceType?: ReferenceType; // (optional for UI caching)
  referenceId: string;
  note?: string;
  createdAt: number;
}
...
export interface PerformanceMetrics {
  ...
  peakEquity: string;       // Peak equity (USD)
  totalRealizedPnl: string; // Total realized PnL (USD)
}

...
export interface SymbolDefinition {
  ...
  sources: {
    /** Binance WebSocket symbol (e.g., "btcUSD") - lowercase required */
    binance?: string;
...
export const CRYPTO_SYMBOLS: SymbolDefinition[] = [
  ...
  { symbol: 'BTC/USD', name: 'Bitcoin', kind: 'crypto', base: 'BTC', quote: 'USD', tickSize: 0.01, lotSize: 0.00001, sources: { binance: 'btcUSD', yahoo: 'BTC-USD' } },
  { symbol: 'ETH/USD', name: 'Ethereum', kind: 'crypto', base: 'ETH', quote: 'USD', tickSize: 0.01, lotSize: 0.0001, sources: { binance: 'ethUSD', yahoo: 'ETH-USD' } },
  { symbol: 'BNB/USD', name: 'BNB', kind: 'crypto', base: 'BNB', quote: 'USD', tickSize: 0.01, lotSize: 0.001, sources: { binance: 'bnbUSD', yahoo: 'BNB-USD' } },
  { symbol: 'XRP/USD', name: 'Ripple', kind: 'crypto', base: 'XRP', quote: 'USD', tickSize: 0.0001, lotSize: 0.1, sources: { binance: 'xrpUSD', yahoo: 'XRP-USD' } },
  { symbol: 'SOL/USD', name: 'Solana', kind: 'crypto', base: 'SOL', quote: 'USD', tickSize: 0.01, lotSize: 0.01, sources: { binance: 'solUSD', yahoo: 'SOL-USD' } },
  { symbol: 'ADA/USD', name: 'Cardano', kind: 'crypto', base: 'ADA', quote: 'USD', tickSize: 0.0001, lotSize: 1, sources: { binance: 'adaUSD', yahoo: 'ADA-USD' } },
  { symbol: 'DOGE/USD', name: 'Dogecoin', kind: 'crypto', base: 'DOGE', quote: 'USD', tickSize: 0.00001, lotSize: 1, sources: { binance: 'dogeUSD', yahoo: 'DOGE-USD' } },
  { symbol: 'DOT/USD', name: 'Polkadot', kind: 'crypto', base: 'DOT', quote: 'USD', tickSize: 0.001, lotSize: 0.1, sources: { binance: 'dotUSD', yahoo: 'DOT-USD' } },
  { symbol: 'AVAX/USD', name: 'Avalanche', kind: 'crypto', base: 'AVAX', quote: 'USD', tickSize: 0.01, lotSize: 0.01, sources: { binance: 'avaxUSD', yahoo: 'AVAX-USD' } },
  { symbol: 'LINK/USD', name: 'Chainlink', kind: 'crypto', base: 'LINK', quote: 'USD', tickSize: 0.001, lotSize: 0.01, sources: { binance: 'linkUSD', yahoo: 'LINK-USD' } },
  { symbol: 'MATIC/USD', name: 'Polygon', kind: 'crypto', base: 'MATIC', quote: 'USD', tickSize: 0.0001, lotSize: 1, sources: { binance: 'maticUSD', yahoo: 'MATIC-USD' } },
  { symbol: 'LTC/USD', name: 'Litecoin', kind: 'crypto', base: 'LTC', quote: 'USD', tickSize: 0.01, lotSize: 0.001, sources: { binance: 'ltcUSD', yahoo: 'LTC-USD' } },

  // Stablecoins (useful for monitoring peg stability)
  { symbol: 'USDC/USD', name: 'USD Coin', kind: 'crypto', base: 'USDC', quote: 'USD', tickSize: 0.0001, lotSize: 1, sources: { binance: 'usdcUSD', yahoo: 'USDC-USD' } },
];
